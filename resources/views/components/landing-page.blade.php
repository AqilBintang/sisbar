            ...
            <div class="text-center mb-16 pt-12">
                ...
                <div class="max-w-4xl mx-auto">
                    <p class="text-lg text-gray-300 mb-4 leading-relaxed">
                        Percayakan penampilan terbaik Anda kepada ahlinya. Di <span class="text-yellow-400 font-semibold">Sisbar Hairstudio</span>, 
                        kami memahami bahwa gaya rambut yang tepat dapat meningkatkan kepercayaan diri dan memberikan kesan profesional yang sempurna.
                    </p>
                    <p class="text-lg text-gray-300 leading-relaxed">
                        Dengan pengalaman bertahun-tahun dan dedikasi tinggi, kami hadir untuk memberikan layanan premium 
                        yang mengutamakan kualitas, kenyamanan, dan kepuasan setiap klien.
                    </p>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-8 mb-12">
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="text-white font-medium text-sm mb-2">Premium Haircut</h3>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="text-white font-medium text-sm mb-2">Classic Shaving</h3>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="text-white font-medium text-sm mb-2">Hair Styling</h3>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="text-white font-medium text-sm mb-2">Beard Treatment</h3>
                        </div>
                    </div>
                    ...
                    <div class="text-gray-300 leading-relaxed mb-8 space-y-4">
                        <p>
                            <span class="text-yellow-400 font-semibold">Sisbar Hairstudio</span> menghadirkan layanan grooming pria terlengkap 
                            dengan standar internasional. Dari haircut klasik hingga styling modern, setiap detail dikerjakan dengan presisi tinggi 
                            oleh barber profesional berpengalaman.
                        </p>
                        <p>
                            Berlokasi strategis di <span class="text-yellow-400 font-semibold">Yogyakarta</span>, kami berkomitmen menjadi 
                            destinasi utama pria modern yang mengutamakan penampilan berkelas. Dengan fasilitas premium dan atmosfer yang nyaman, 
                            setiap kunjungan adalah pengalaman yang tak terlupakan.
                        </p>
                        <p>
                            <strong class="text-yellow-400">Visi Kami:</strong> Menjadi barbershop terdepan yang mengombinasikan tradisi klasik 
                            dengan inovasi modern, menciptakan gaya yang timeless namun tetap contemporary.
                        </p>
                    </div>
                </div>
